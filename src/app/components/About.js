...
const About = () => {
  return (
    <section className=" py-16 px-4 sm:px-6 lg:px-8 w-screen   about">
      <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row gap-10 items-center justify-between space-y-10 lg:space-y-0">
        ...
        <div className="lg:w-1/2 text-center lg:text-left bg-white bg-opacity-5  rounded-md min-w-[260px] max-w-[700px] box-border p-10">
          ...
          <p className="text-lg text-gray-600 mb-6">
            At Gion, we are committed to empowering ideas with cutting-edge technology.
    ...
    <div
  className="bg-white bg-opacity-5 rounded-md flex items-center justify-center p-3 border-l border-green-500 text-gray-600 "
